(function(e){var i=new google.maps.Geocoder;e.fn.autoGeocoder=function(b){var a=e.fn.autoGeocoder,b=e.extend(!0,{},a.defaults,b||{}),a=b.setup||a.base;for(property in a)for(var d=a[property],c=0,f=d.length;c<f;c++)d[c].call(this,b);return this.trigger("auto-geocoder.initialize")};e.fn.autoGeocoder.base={initialize:[function(b){b.initial.center=google.maps.LatLng.call(this,b.initial.center);this.on("auto-geocoder.initialize",function(){e(this).trigger("auto-geocoder.createMap").trigger("auto-geocoder.onKeyUp")})}],
...
g==c||(""==c?d.trigger("auto-geocoder.onGeocodeResult",[[],""]):this.timeout=setTimeout(function(){a.previousAddress=c;i.geocode({address:c},function(a,b){d.trigger("auto-geocoder.onGeocodeResult",[a,b])})},b.delay))})}],onGeocodeResult:[function(b){this.get(0).marker=new google.maps.Marker;this.on("auto-geocoder.onGeocodeResult",function(a,d,c){var a=this.map,f=this.marker;if(c==google.maps.GeocoderStatus.OK){var g=d[0].geometry,h=g.location;"auto"==b.success.zoom?a.fitBounds(g.viewport):(a.setZoom(b.success.zoom),
